...
<div style="background-color:skyblue;margin-left:28px;padding:99px">
<div class="row">
<label>Name:</label> <br>
<input type="text" name="name" style="padding-bottom:18px;padding-right:89px"/><br>
<label>Country:</label><br/> 
<select name="country" style="padding-bottom:18px;padding-right:89px" id="country-list"  onChange="getState(this.value); ">
